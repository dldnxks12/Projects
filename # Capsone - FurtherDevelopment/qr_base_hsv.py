...
try:
	while True:		
		...
		if (Init_distance == False):	# After distance init finished ...		
			...
			if len(decoded_QR) != 0:
				for d in decoded_QR:				
					decoded_direction = d.data.decode('utf-8')
					cv2.rectangle(color_image, (d.rect[0],d.rect[1]), (d.rect[0] + d.rect[2], d.rect[1]+d.rect[3]), (0,0,255), 2)
					print("QR Code detected !! ----> ", decoded_direction)

				if decoded_direction == 'R':
					Left_Wheel      = 100
					Right_Wheel     = 100
					Left_direction  = 1
					Right_direction = 0	
				...
				elif decoded_direction == 'S':					
					Left_Wheel      = 50
					Right_Wheel     = 50
					Left_direction  = 1
					Right_direction = 1	

				elif decoded_direction == 'F':					
					Left_Wheel      = 120
					Right_Wheel     = 120
					Left_direction  = 1
					Right_direction = 1
					...
					print("decoded QR Code is wring ... ")
