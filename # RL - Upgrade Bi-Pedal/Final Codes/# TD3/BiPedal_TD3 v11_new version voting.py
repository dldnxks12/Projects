...
mu_optimizer3 = optim.Adam(mu3.parameters(), lr=0.0005)
mu_optimizer4 = optim.Adam(mu4.parameters(), lr=0.0005)
mu_optimizer5 = optim.Adam(mu5.parameters(), lr=0.0005)
mu_optimizer6 = optim.Adam(mu6.parameters(), lr=0.0005)
mu_optimizer7 = optim.Adam(mu7.parameters(), lr=0.0005)
mu_optimizer8 = optim.Adam(mu8.parameters(), lr=0.0005)
...
plt.savefig('TD3_ensemble_model_newversion3.png')

avg_history = np.array(avg_history)
np.save("./TD3_ensemble_model_newversion3", avg_history)
np.save("./TD3_ensemble_model_newversion_Softmax3", softmax_recores)