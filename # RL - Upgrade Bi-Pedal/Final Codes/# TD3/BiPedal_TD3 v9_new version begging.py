...
plt.savefig('TD3 TD3_ensemble_model_newversion begging 2.png')

avg_history = np.array(avg_history)
np.save("./TD3_ensemble_model_newversion begging 2", avg_history)
np.save("./TD3_ensemble_model_newversionbegging_Softmax 2", softmax_recores)