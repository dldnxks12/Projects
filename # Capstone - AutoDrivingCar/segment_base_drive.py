...
try:
	while True:		
		...
		vertices = np.array([[(0,height),(width/2-200, height/2 + 30), (width/2+200, height/2 + 30), (width,height)]], dtype=np.int32)  		
		...
		merge = np.hstack((canvas3, canvas, canvas2))
		cv2.imshow("# Approx Contour     ||     Drive Line     ||     Position #", merge)						
