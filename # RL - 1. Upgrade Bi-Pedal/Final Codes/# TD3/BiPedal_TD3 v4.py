...
mu_optimizer2 = optim.Adam(mu2.parameters(), lr=0.00001)
mu_optimizer3 = optim.Adam(mu3.parameters(), lr=0.00005)
q_optimizer1 = optim.Adam(q1.parameters(), lr=0.0005)
q_optimizer2 = optim.Adam(q2.parameters(), lr=0.0001)
