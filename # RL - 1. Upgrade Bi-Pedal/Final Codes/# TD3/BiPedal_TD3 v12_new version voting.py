...
plt.savefig('TD3_ensemble_model_newversion4.png')

avg_history = np.array(avg_history)
np.save("./TD3_ensemble_model_newversion4", avg_history)
np.save("./TD3_ensemble_model_newversion_Softmax4", softmax_recores)